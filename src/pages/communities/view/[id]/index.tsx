...
import { getCommunityById } from 'apiSdk/communities';
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('community', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/communities/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="community" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
